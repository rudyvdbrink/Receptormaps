function cortsurfr(g,dat)
% CORTSURFR(gr,rdat) plots the data in rdat onto the cortical surface of 
% the right hemisphere. The data are z-scored across space prior to plotting 
